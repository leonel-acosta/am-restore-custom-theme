 ...
 *
 * Renders an optional page intro, a list of service cards, and an optional about section.
 *
 * ACF field group: "Page: Services" (group_services_page_001)
 */
...
<div id="content" class="site-content">
    ...
    <main id="main" class="site-main services-page" role="main">
        ...
        <?php if (! empty($about_us['heading']) || ! empty($about_us['content'])) :
            get_template_part('template-parts/sections/text', null, [
                ...
                'direction'      => $about_us['direction']      ?? 'row',
                'align'          => $about_us['align']          ?? 'left',
                'padding'        => $about_us['padding']        ?? 'md',
                'border_content' => $about_us['border_content'] ?? true,
            ]);
        endif; ?>
    </main>
